...
all_day: false
event: SL Math Summer School - Principled Scientific Discovery with Formal Methods at IBM T. J. Watson Research Center, Yorktown Heights, NY
event_url: 
...
You can find the slides for my lecture {{% staticref "files/algorithm_generation_lecture_slides.pdf" %}} here {{% /staticref %}} and the slides for my tutorial {{% staticref "files/algorithm_generation_tutorial_slides.pdf" %}} here {{% /staticref %}}.